...
def createProfile(InputFolder,OutFolder,InFolder):                 #900
    ...
    for index, row in input_df.iterrows():
        ...
        Flag2 = createScripts(InFolder,OutFolder,ProfileNumber,CleanUpScriptFile,TowerHeight1,TowerHeight2,AntennaHeight1,AntennaHeight2,PathDistance,Site1,Site2) #Create scripts
        
        createDataFiles(InFolder, OutFolder,ProfileNumber,CleanUpScriptFile,Flag2,AntennaHeight1 ) #Create data files
...
def createScripts(InFolder, OutFolder,ProfileNumber,CleanUpScriptFile,TowerHeight1,TowerHeight2,AntennaHeight1,AntennaHeight2,PathDistance,Site1,Site2): #1000
...
def createDataFiles(InFolder,OutFolder,ProfileNumber,CleanUpScriptFile,Flag2,AntennaHeight1): #2000
...
if(SysOpt == "Y"):
    ...
    createProfile(InputFolder,OutFolder,InFolder)
