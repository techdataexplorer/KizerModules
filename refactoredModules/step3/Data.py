...
test.setFolderPath(ExampleS3FolderPath = ex.openFolderNameDialog("Find ExampleS3 Folder"))
#test.setRadioPath("C:/Users/ecuth/Desktop/Spatial Datalyst/Kizer/Radios") 
test.setRadioPath(ExampleRadioPath = ex.openFolderNameDialog("Find Radio Folder"))
#test.setAntennaPath("C:/Users/ecuth/Desktop/Spatial Datalyst/Kizer/Antennas")
test.setAntennaPath(ExampleAntenaaPath = ex.openFolderNameDialog("Find Antenna Folder"))
test.execute()