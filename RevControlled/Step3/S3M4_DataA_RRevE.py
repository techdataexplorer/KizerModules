...
class Data(object):
    ...
    def calculateFreeSpaceLossAtmosphericAttenuation(self, PathIndex, Freq, FilePath):
        ...
        #changed this line, indented this if statement
                if MatchFlag == 0:
    ...
    def execute(self):
        FilePath = Path(str(self.ExampleS3FolderPath) + "/Data/PathDataPass1.csv")
        ...
        RadioFilePath = Path(str(self.RadioFolderPath) + "/RadioFilesRev1.csv")

        # Get local AntennaFilesRev1.csv file path from pyqt interface 
        AntennaFilePath = Path(str(self.AntennaFolderPath) + "/AntennaFilesRev1.csv")

        # Get local WaveguideRev1.csv file path from pyqt interface 
        WaveGuideFilePath = Path(str(self.AntennaFolderPath) + "/WaveguideRev1.csv")
        ...
        AveragePathFilePath = Path(str(self.ExampleS3FolderPath) + "/AveragePaths.csv")
        ...
        for index, row in path_data_pass_df_1.iterrows():
            ...
            radio_file_df = pd.read_csv(Path(RadioFilePath))
            ...
            PrintFile = str(PathIndex) + "," + str(Company) + "," + str(RadioModel) + "," + str(AltRadioModel) + "," + str(FreqAvg) + ",V," + str(int(ChannelBW)) + "," + str(DataRate) + "," + str(Modulation) + "," + str(int(Threshold)) + "," + str(ACMoffset) + "," + str(int(DFM)) + "," + str(int(TXpwr)) + "," + str(TXcoupling) + "," + str(RXcoupling) + ","
            ...
            if not (TransLine != TransLine): # string test for nan
                ...
                if LineAttn:
                    ...
                    PrintFile = str(LeftWaveguide) + "," + str(LeftWGLengthft) + "," + str(LeftLineAttn) + "," + str(RightWaveguide) + "," + str(int(RightWGLengthft)) + "," + str(RightLineAttn) + ","
                    print(PrintFile)
                    path_data_pass_df_2.write(PrintFile)
            else:
                PrintFile = "" + "," + "" + "," + "" + "," + "" + "," + "" + "," + "" + ","
            ...
            if RelDispFactor:
                PrintFile = str(int(RelDispFactor)) + ","
                print(PrintFile)
                path_data_pass_df_2.write(PrintFile)
            ...
            PrintFile = str(int(WidthMHz)) + "," + str(DepthDB) + ",0,0"
            print(PrintFile)
            path_data_pass_df_2.write(PrintFile)
...
ExampleRadioPath = Path(ex.openFolderNameDialog("Find Radio Folder"))
test.setRadioPath(ExampleRadioPath)
#test.setAntennaPath("C:/Users/ecuth/Desktop/Spatial Datalyst/Kizer/Antennas")
ExampleAntennaPath = Path(ex.openFolderNameDialog("Find Antenna Folder"))
