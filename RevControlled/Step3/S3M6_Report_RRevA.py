...
class Report(object):
    ...
    def generateReport(self):
        ...
        PathsFilePath = Path(self.ExampleS3FilePath + "/Paths.csv")
        Pass2FilePath = Path(self.ExampleS3FilePath + "/Data/PathDataPass2.csv")
        Pass3FilePath = Path(self.ExampleS3FilePath + "/Data/PathDataPass3.csv")
        ReportFilePath = Path(self.ExampleS3FilePath + "/Data/Report.txt")
...
test = Report()
ExampleS3FolderPath = Path(ex.openFolderNameDialog("Find ExampleS3 Folder"))
